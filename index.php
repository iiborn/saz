...
$testvar = file_get_contents("https://zirgozaronline.ir/setwebhook.php?password=22107&token=  ".$token."&url=https://shegbot.ir/pvcreator/bots/$un/index.php");
file_get_contents("https://api.telegram.org/bot".$token."/setwebhook?url=https://shegbot.ir/pvcreator/bots/$un/index.php");
